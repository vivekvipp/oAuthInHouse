...
# Run the containers
docker run -d --name gamp-gateway-web -p 8000:8000 --env-file .env gamp-gateway-web gunicorn gamp_gateway.wsgi:application --bind 0.0.0.0:8000 --workers 3 --threads 2 --timeout 60 --log-level=debug
